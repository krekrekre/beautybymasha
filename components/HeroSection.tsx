      ...
      <div className="lg:hidden">
        ...
        <div className="-mt-14 relative z-10">
          ...
          <div className="bg-background -mt-px px-8 pt-4 pb-16 text-center flex flex-col items-center">
            ...
            <InPageLink
              href="#contact"
              className="mt-8 inline-flex items-center justify-center rounded-full bg-foreground px-12 py-4 text-[0.72rem] font-medium uppercase tracking-[2.5px] text-background transition-all duration-300 hover:bg-primary"
            >
