          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[1.05rem] text-body-muted">
              ...
              <li className="flex items-start gap-4 group">
                <span className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary transition-colors group-hover:bg-primary group-hover:text-white">
